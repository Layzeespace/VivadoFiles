...
HD_PWD='C:/Users/nbut9/VivadoFiles/Lab1_BertButEt/Lab1_BertButEt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1source.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1source.tcl -notrace
