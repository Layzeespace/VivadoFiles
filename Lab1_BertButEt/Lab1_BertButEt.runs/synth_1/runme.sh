...
HD_PWD='C:/Users/nbut9/VivadoFiles/Lab1_BertButEt/Lab1_BertButEt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1source.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1source.tcl
