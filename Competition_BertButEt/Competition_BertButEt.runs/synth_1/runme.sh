...
HD_PWD='C:/Users/nbut9/VivadoFiles/Competition_BertButEt/Competition_BertButEt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_source.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5_source.tcl
